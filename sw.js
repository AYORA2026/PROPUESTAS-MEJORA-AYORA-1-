const CACHE='ayora-propuestas-v3';
const ASSETS=['./','index.html','styles.css','app.js','manifest.webmanifest','assets/icon.svg','assets/template-part-01.txt','assets/template-part-02.txt','assets/template-part-03.txt','assets/template-part-04.txt','assets/template-part-05.txt','assets/template-part-06.txt','assets/template-part-07.txt','https://cdn.jsdelivr.net/npm/pdf-lib@1.17.1/dist/pdf-lib.min.js'];
